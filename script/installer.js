...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    ...
    appDirectory: path.join(outPath, 'cdn-server-electron-win32-ia32'),
    ...
    iconUrl: path.join(rootPath, 'app', 'assets', 'images', 'app.ico'),
    //loadingGif: path.join(rootPath, 'assets', 'img', 'loading.gif'),
    noMsi: true,
    outputDirectory: path.join(outPath, 'windows-installer'),
    setupExe: 'DotCDN.exe',
    setupIcon: path.join(rootPath, 'app', 'assets', 'images', 'app.ico'),
    //skipUpdateIcon: true
  })
}
