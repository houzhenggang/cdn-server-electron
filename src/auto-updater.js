...
exports.checkUpdate = function (callback) {
  autoUpdater.on("checking-for-update", function(event){
    util.logger("checking-for-update")
    util.logger(event)
  })
  autoUpdater.on("update-downloaded", function(event, releaseNotes, releaseName, releaseDate, updateURL){
    util.logger("update-downloaded")
    util.logger(event)
    util.logger(releaseNotes)
    util.logger(releaseName)
    util.logger(releaseDate)
    util.logger(updateURL)
